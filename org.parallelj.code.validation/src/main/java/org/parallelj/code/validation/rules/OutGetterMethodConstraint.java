...
public class OutGetterMethodConstraint extends AbstractParallelJCodeRule {

	@Override
	public boolean visit(FieldDeclaration node) {

		Annotation annotation = getAnnotation(node, "org.parallelj.launching",
				ParallelJAPI.OUT);
	...
	private void checkGetterMethod(ASTNode node,
		...
		if (!flag) {
			addErrorMarker(node,
					ValidationMessages.OUT_GETTER_METHOD_NOT_FOUND.value(
