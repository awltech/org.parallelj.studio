 ...
 * @generated
 */
public class ParallelJNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = ParallelJDiagramEditorPlugin.getInstance()
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		ParallelJAbstractNavigatorItem abstractNavigatorItem = (ParallelJAbstractNavigatorItem) aSelection
				.getFirstElement();
		View navigatorView = null;
		if (abstractNavigatorItem instanceof ParallelJNavigatorItem) {
			navigatorView = ((ParallelJNavigatorItem) abstractNavigatorItem)
					.getView();
			...
			if (navigatorGroup.getParent() instanceof ParallelJNavigatorItem) {
				navigatorView = ((ParallelJNavigatorItem) navigatorGroup
						.getParent()).getView();
			}
		}
