 ...
 * @generated
 */
public class ParallelJNavigatorSorter extends ViewerSorter {
	...
	public int category(Object element) {
		if (element instanceof ParallelJNavigatorItem) {
			ParallelJNavigatorItem item = (ParallelJNavigatorItem) element;
			return ParallelJVisualIDRegistry.getVisualID(item.getView());
		}
