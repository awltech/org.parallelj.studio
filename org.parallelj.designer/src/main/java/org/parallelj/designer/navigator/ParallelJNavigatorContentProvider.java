...
public class ParallelJNavigatorContentProvider implements
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case PipelineEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			ParallelJNavigatorGroup incominglinks = new ParallelJNavigatorGroup(
					Messages.NavigatorGroupName_Pipeline_3009_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ParallelJNavigatorGroup outgoinglinks = new ParallelJNavigatorGroup(
					Messages.NavigatorGroupName_Pipeline_3009_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case PipelineProcedureEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			ParallelJNavigatorGroup incominglinks = new ParallelJNavigatorGroup(
					Messages.NavigatorGroupName_Procedure_3010_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			ParallelJNavigatorGroup outgoinglinks = new ParallelJNavigatorGroup(
					Messages.NavigatorGroupName_Procedure_3010_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					ParallelJVisualIDRegistry.getType(LinkEditPart.VISUAL_ID));
