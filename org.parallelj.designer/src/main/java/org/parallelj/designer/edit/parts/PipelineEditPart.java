...
public class PipelineEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PipelineIterableEditPart) {
			((PipelineIterableEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePipelineIterableFigure());
			return true;
		}
	...
	public class PipelineFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigurePipelineIterablePrecedingFigure;
		/**
		 * @generated
		 */
		private WrappingLabel fFigurePipelineIterableFigure;
		/**
		 * @generated
		 */
		...
		private void createContents() {
			...
			pipelineNameHolder1.setBorder(new MarginBorder(getMapMode().DPtoLP(
					4), getMapMode().DPtoLP(0), getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(0)));
			...
			RectangleFigure pipelineNameHolderFigure2 = new RectangleFigure();
			pipelineNameHolderFigure2.setFill(false);
			pipelineNameHolderFigure2.setOutline(false);
			pipelineNameHolderFigure2.setBorder(new MarginBorder(getMapMode()
					.DPtoLP(0), getMapMode().DPtoLP(0), getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(0)));

			GridData constraintPipelineNameHolderFigure2 = new GridData();
			constraintPipelineNameHolderFigure2.verticalAlignment = GridData.CENTER;
			constraintPipelineNameHolderFigure2.horizontalAlignment = GridData.CENTER;
			...
			pipelineNameHolder1.add(pipelineNameHolderFigure2,
					constraintPipelineNameHolderFigure2);

			GridLayout layoutPipelineNameHolderFigure2 = new GridLayout();
			...
			pipelineNameHolderFigure2
					.setLayoutManager(layoutPipelineNameHolderFigure2);
			...
			pipelineNameHolderFigure2.add(fFigurePipelineIconFigure,
			...
			pipelineNameHolderFigure2.add(fFigurePipelineNameFigure,
					constraintFFigurePipelineNameFigure);

			RectangleFigure pipelineIterableHolderFigure2 = new RectangleFigure();
			pipelineIterableHolderFigure2.setFill(false);
			pipelineIterableHolderFigure2.setOutline(false);
			pipelineIterableHolderFigure2.setBorder(new MarginBorder(
					getMapMode().DPtoLP(-3), getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(-1), getMapMode().DPtoLP(0)));

			GridData constraintPipelineIterableHolderFigure2 = new GridData();
			constraintPipelineIterableHolderFigure2.verticalAlignment = GridData.CENTER;
			constraintPipelineIterableHolderFigure2.horizontalAlignment = GridData.CENTER;
			...
			pipelineNameHolder1.add(pipelineIterableHolderFigure2,
					constraintPipelineIterableHolderFigure2);

			GridLayout layoutPipelineIterableHolderFigure2 = new GridLayout();
			...
			pipelineIterableHolderFigure2
					.setLayoutManager(layoutPipelineIterableHolderFigure2);

			fFigurePipelineIterablePrecedingFigure = new WrappingLabel();
			fFigurePipelineIterablePrecedingFigure.setText("");
			fFigurePipelineIterablePrecedingFigure
					.setForegroundColor(ColorConstants.black);

			fFigurePipelineIterablePrecedingFigure
					.setFont(FFIGUREPIPELINEITERABLEPRECEDINGFIGURE_FONT);

			GridData constraintFFigurePipelineIterablePrecedingFigure = new GridData();
			constraintFFigurePipelineIterablePrecedingFigure.verticalAlignment = GridData.CENTER;
			constraintFFigurePipelineIterablePrecedingFigure.horizontalAlignment = GridData.CENTER;
			...
			pipelineIterableHolderFigure2.add(
					fFigurePipelineIterablePrecedingFigure,
					constraintFFigurePipelineIterablePrecedingFigure);

			fFigurePipelineIterableFigure = new WrappingLabel();
			fFigurePipelineIterableFigure.setText("");

			fFigurePipelineIterableFigure
					.setFont(FFIGUREPIPELINEITERABLEFIGURE_FONT);

			GridData constraintFFigurePipelineIterableFigure = new GridData();
			constraintFFigurePipelineIterableFigure.verticalAlignment = GridData.CENTER;
			constraintFFigurePipelineIterableFigure.horizontalAlignment = GridData.CENTER;
			...
			pipelineIterableHolderFigure2.add(fFigurePipelineIterableFigure,
					constraintFFigurePipelineIterableFigure);
			...
			fFigurePipelineSplitFigure.setBorder(new MarginBorder(getMapMode()
					.DPtoLP(1), getMapMode().DPtoLP(5), getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(0)));
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePipelineIterablePrecedingFigure() {
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePipelineIterableFigure() {
	 ...
	 * @generated
	 */
	static final Font FFIGUREPIPELINEITERABLEPRECEDINGFIGURE_FONT = new Font(
			Display.getCurrent(), Display.getDefault().getSystemFont()
	 ...
	 * @generated
	 */
	static final Font FFIGUREPIPELINEITERABLEFIGURE_FONT = new Font(
			Display.getCurrent(), Display.getDefault().getSystemFont()
