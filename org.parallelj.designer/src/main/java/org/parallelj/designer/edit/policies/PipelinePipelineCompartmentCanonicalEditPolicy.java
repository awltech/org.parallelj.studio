 ...
 * @generated
 */
public class PipelinePipelineCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ParallelJPackage.eINSTANCE.getPipeline_Procedures();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ParallelJNodeDescriptor> childDescriptors = ParallelJDiagramUpdater
				.getPipelinePipelineCompartment_7004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return PipelineProcedureEditPart.VISUAL_ID == ParallelJVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ParallelJNodeDescriptor> childDescriptors = ParallelJDiagramUpdater
				.getPipelinePipelineCompartment_7004SemanticChildren((View) getHost()
						.getModel());
