...
import org.parallelj.designer.edit.policies.BlockProcedureItemSemanticEditPolicy;
 ...
 * @generated
 */
public class BlockProcedureEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public BlockProcedureEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BlockProcedureItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof BlockProcedureNameEditPart) {
			((BlockProcedureNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureProcedureNameFigure());
			return true;
		}
		if (childEditPart instanceof BlockProcedureExecutableEditPart) {
			((BlockProcedureExecutableEditPart) childEditPart)
