...
public class LinkReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		Element target = getLink().getDestination();
		return ParallelJBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistLink_4001(getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return ParallelJBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistLink_4001(getLink(), source, getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getOutputLinks().remove(getLink());
		getNewSource().getOutputLinks().add(getLink());
