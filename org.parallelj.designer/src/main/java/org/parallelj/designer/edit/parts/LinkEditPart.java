...
import org.parallelj.designer.edit.policies.LinkItemSemanticEditPolicy;
...
public class LinkEditPart extends ConnectionNodeEditPart implements
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LinkPredicateInfoEditPart) {
			((LinkPredicateInfoEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureLinkPredicateInfoFigure());
			return true;
		}
		return false;
	}
	...
	public class LinkFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureLinkPredicateInfoFigure;
		...
		private void createContents() {
			...
			fFigureLinkPredicateInfoFigure = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureLinkPredicateInfoFigure() {
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 50, 50, 50);
