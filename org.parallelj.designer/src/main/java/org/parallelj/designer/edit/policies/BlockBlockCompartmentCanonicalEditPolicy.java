 ...
 * @generated
 */
public class BlockBlockCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ParallelJPackage.eINSTANCE.getBlock_Procedures();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ParallelJNodeDescriptor> childDescriptors = ParallelJDiagramUpdater
				.getBlockBlockCompartment_7003SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return BlockProcedureEditPart.VISUAL_ID == ParallelJVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ParallelJNodeDescriptor> childDescriptors = ParallelJDiagramUpdater
				.getBlockBlockCompartment_7003SemanticChildren((View) getHost()
						.getModel());
