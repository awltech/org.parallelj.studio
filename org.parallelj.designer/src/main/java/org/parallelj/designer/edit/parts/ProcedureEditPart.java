...
import org.parallelj.designer.edit.policies.ProcedureItemSemanticEditPolicy;
...
public class ProcedureEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProcedureNameEditPart) {
			((ProcedureNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureProcedureNameFigure());
			return true;
		}
		if (childEditPart instanceof ProcedureExecutableEditPart) {
			((ProcedureExecutableEditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.parallelj.designer.edit.parts.ProcedureEditPart) {
			types.add(ParallelJElementTypes.Link_4001);
		}
