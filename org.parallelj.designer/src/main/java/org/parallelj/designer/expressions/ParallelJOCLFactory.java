	...
	public static ParallelJAbstractExpression getExpression(int index,
		...
		if (cached.expressions[index] == null) {
			final String[] exprBodies = new String[] {
					"not self.oclIsTypeOf(ForEachLoop) and not self.oclIsTypeOf(WhileLoop) and not self.oclIsTypeOf(Handler) and not self.oclIsTypeOf(Block) and not self.oclIsTypeOf(BusinessProcedure)", //$NON-NLS-1$
