 ...
 * @generated
 */
public class ParallelJInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new ParallelJNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SpecificationEditPart.MODEL_ID));
		ParallelJDiagramEditorUtil.runWizard(getShell(), wizard,
