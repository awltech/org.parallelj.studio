...
public class ParallelJDiagramUpdater {
	...
	public static List<ParallelJNodeDescriptor> getSemanticChildren(View view) {
		...
		case PipelinePipelineCompartmentEditPart.VISUAL_ID:
			return getPipelinePipelineCompartment_7004SemanticChildren(view);
		}
	 ...
	 * @generated
	 */
	public static List<ParallelJNodeDescriptor> getPipelinePipelineCompartment_7004SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
	...
	public static List<ParallelJLinkDescriptor> getContainedLinks(View view) {
		...
		case PipelineEditPart.VISUAL_ID:
			return getPipeline_3015ContainedLinks(view);
		case PipelineProcedureEditPart.VISUAL_ID:
			return getProcedure_3016ContainedLinks(view);
	...
	public static List<ParallelJLinkDescriptor> getIncomingLinks(View view) {
		...
		case PipelineEditPart.VISUAL_ID:
			return getPipeline_3015IncomingLinks(view);
		case PipelineProcedureEditPart.VISUAL_ID:
			return getProcedure_3016IncomingLinks(view);
		case DataEditPart.VISUAL_ID:
	...
	public static List<ParallelJLinkDescriptor> getOutgoingLinks(View view) {
		...
		case PipelineEditPart.VISUAL_ID:
			return getPipeline_3015OutgoingLinks(view);
		case PipelineProcedureEditPart.VISUAL_ID:
			return getProcedure_3016OutgoingLinks(view);
		case DataEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	public static List<ParallelJLinkDescriptor> getPipeline_3015ContainedLinks(
			View view) {
	 ...
	 * @generated
	 */
	public static List<ParallelJLinkDescriptor> getProcedure_3016ContainedLinks(
			View view) {
		Procedure modelElement = (Procedure) view.getElement();
		LinkedList<ParallelJLinkDescriptor> result = new LinkedList<ParallelJLinkDescriptor>();
		result.addAll(getContainedTypeModelFacetLinks_Link_4001(modelElement));
	 ...
	 * @generated
	 */
	public static List<ParallelJLinkDescriptor> getPipeline_3015IncomingLinks(
			View view) {
		Pipeline modelElement = (Pipeline) view.getElement();
		Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
				.find(view.eResource().getResourceSet().getResources());
	 ...
	 * @generated
	 */
	public static List<ParallelJLinkDescriptor> getProcedure_3016IncomingLinks(
			View view) {
		Procedure modelElement = (Procedure) view.getElement();
		Map<EObject, Collection<EStructuralFeature.Setting>> crossReferences = EcoreUtil.CrossReferencer
				.find(view.eResource().getResourceSet().getResources());
	 ...
	 * @generated
	 */
	public static List<ParallelJLinkDescriptor> getPipeline_3015OutgoingLinks(
			View view) {
		Pipeline modelElement = (Pipeline) view.getElement();
		LinkedList<ParallelJLinkDescriptor> result = new LinkedList<ParallelJLinkDescriptor>();
		result.addAll(getContainedTypeModelFacetLinks_Link_4001(modelElement));
	 ...
	 * @generated
	 */
	public static List<ParallelJLinkDescriptor> getProcedure_3016OutgoingLinks(
			View view) {
		Procedure modelElement = (Procedure) view.getElement();
		LinkedList<ParallelJLinkDescriptor> result = new LinkedList<ParallelJLinkDescriptor>();
		result.addAll(getContainedTypeModelFacetLinks_Link_4001(modelElement));
