...
public enum EnumConstantTestClass {
	/** MERCURY informations */
	@Generated("XA Designer")
	...
	NEPTUNE(1.024e+26, 2.4746e7), TEST(1.024e+26, 2.4746e7);
	 ...
	 */
	@Generated("XA Designer")
	EnumConstantTestClass(double mass, double radius) throws IllegalAccessError {
		this.mass = mass;
		this.radius = radius;
	}
