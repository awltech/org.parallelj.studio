...
public class PropertiesActivator extends AbstractUIPlugin {
	...
	// The shared instance
	private static PropertiesActivator plugin;

	/**
	 * The constructor
	 */
	public PropertiesActivator() {
	}
	...
	public void stop(BundleContext context) throws Exception {
		if (this.imageRegistryUsed) {
			PropertiesActivator.plugin.getImageRegistry().dispose();
		}
		plugin = null;
		super.stop(context);
	}
	 ...
	 */
	public static PropertiesActivator getDefault() {
		return plugin;
	}

	public void logInfo(String message) {
		getLog().log(
				new Status(IStatus.INFO, PropertiesActivator.PLUGIN_ID,
						message, null));
	}

	public void logWarn(String message) {
		getLog().log(
				new Status(IStatus.WARNING, PropertiesActivator.PLUGIN_ID,
						message, null));
	}

	public void logError(String message) {
		getLog().log(
				new Status(IStatus.ERROR, PropertiesActivator.PLUGIN_ID,
						message, null));
	}
	...
	public Image getImage(String imageFilePath) {
		return this.getImage(PropertiesActivator.PLUGIN_ID, imageFilePath);
	}
	...
	public Image getImage(String pluginId, String imageFilePath) {
		...
		Image image = PropertiesActivator.getDefault().getImageRegistry()
	...
	private synchronized Image loadImage(String pluginId, String imageFilePath) {
		...
		if (imageDescriptor != null) {
			...
			PropertiesActivator.getDefault().getImageRegistry()
