...
public class ProgramBasePropertySection extends Section {

	@Override
	protected void initParts() {
		getZones().put("nameZone", new NameZone(getBackGround(), false));
		getZones().put("capacityZone",
				new CapacityZone(getBackGround(), false, true));
	...
	protected void addLayoutsToParts() {
		...
		new FormDataBuilder().top(getZone("capacityZone")).right()
				.apply(getZone("helpDescription"));
		new FormDataBuilder().top(getZone("capacityZone")).left()
