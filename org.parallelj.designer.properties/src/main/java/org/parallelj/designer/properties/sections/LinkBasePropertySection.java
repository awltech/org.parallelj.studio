...
public class LinkBasePropertySection extends Section {

	@Override
	protected void initParts() {
		getZones().put("predicateZone",
				new PredicateZone(getBackGround(), false, false));
		getZones().put(
				"helpPredicate",
	...
	protected void addLayoutsToParts() {
		new FormDataBuilder().top().right().apply(getZone("helpPredicate"));
		new FormDataBuilder().top().left().right(getZone("helpPredicate"))
