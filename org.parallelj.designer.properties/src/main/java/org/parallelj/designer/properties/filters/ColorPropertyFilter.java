...
public class ColorPropertyFilter extends Filter {

	@Override
	public boolean select(Object toTest) {
		if (toTest instanceof SpecificationEditPart
				|| toTest instanceof InputConditionEditPart
				|| toTest instanceof OutputConditionEditPart
				|| toTest instanceof LinkEditPart)
			return false;
		else
			return true;
	}
