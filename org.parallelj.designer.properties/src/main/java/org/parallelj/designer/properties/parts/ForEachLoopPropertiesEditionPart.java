 ...
 * 
 */
public interface ForEachLoopPropertiesEditionPart {
	...
	/**
	 * Defines a new iterable
	 * @param newValue the new iterable to set
	 * 
	 */
	public void setIterable(Object newValue);

	/**
	 * Adds the given filter to the iterable edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
