 ...
 * 
 */
public interface PipelinePropertiesEditionPart {
	...
	/**
	 * @return the procedures to add
	 * 
	 */
	public List getProceduresToAdd();

	/**
	 * @return the procedures to remove
	 * 
	 */
	public List getProceduresToRemove();

	/**
	 * @return the procedures to move
	 * 
	 */
	public List getProceduresToMove();

	/**
	 * @return the procedures to edit
	 * 
	 */
	public Map getProceduresToEdit();

	/**
	 * @return the current procedures table
	 * 
	 */
	 ...
	 * @param newValue the procedures to update
	 * 
	 */
	public void updateProcedures(EObject newValue);

	/**
	 * Adds the given filter to the procedures edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	...
	/**
	 * @return true if the given element is contained inside the procedures table
	 * 
	 */
