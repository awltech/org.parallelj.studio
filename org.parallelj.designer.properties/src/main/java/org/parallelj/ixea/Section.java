...
/**
 * This class defines a generic Section. A Section is an object that will
 * directly added to the Properties View background
 * 
 * @author Atos Worldline
 * 
 */
public abstract class Section extends AbstractPropertySection {
	 ...
	 * diagram
	 */
	protected DemultiplexingListener eventListener = new DemultiplexingListener(
			getFilter()) {
	...
	/**
	 * @return Filter used for the Listener in charge to keep bijection
	 */
		...
		return NotificationFilter
				...
				.or(
						NotificationFilter
								...
								.and(
										NotificationFilter
												.createNotifierTypeFilter(EObject.class)));
	}

	/**
	 * This method is called when a Section instance is about to be drawn in the
	...
	/**
	 * This method is called when a Section instance is about to be removed in
	...
	/**
	 * This method is called when a Section is being drawn. This method contains
	...
	/**
	 * Added an Item, or a Zone to this section.
	 */
	...
	public final void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (part instanceof DiagramEditor) {
			editingDomain = ((DiagramEditor) part).getEditingDomain();
		}
	...
	/**
	 * @return the backGround of this Section
	 */
	 ...
	 */
	public final Map<String, Zone> getZones() {
		return zones;
	}

	/**
	 * Retrieves the zone contained by this Section from its ID.
	 * 
	 * @param key
	 *            : ID of the Zone
	 * @return : the Zone
