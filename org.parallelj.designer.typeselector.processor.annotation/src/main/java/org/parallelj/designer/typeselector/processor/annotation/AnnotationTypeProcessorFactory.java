...
/**
 * Annotation Type AnnotationProcessor Factory
 * 
 */
public class AnnotationTypeProcessorFactory implements ResourceProcessorFactory {
	...
	public ResourceProcessor createResourceProcessor(IProject project, String pattern) {
		return new AnnotationProcessor(pattern, JavaCore.create(project));
	}
