 ...
 *   <li>{@link org.parallelj.model.impl.PipelineImpl#getIterable <em>Iterable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PipelineImpl extends ProcedureImpl implements Pipeline {
		...
		if (iterable != null && iterable.eIsProxy()) {
			...
			if (iterable != oldIterable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ParallelJPackage.PIPELINE__ITERABLE, oldIterable, iterable));
			}
		}
		return iterable;
	}
	...
	public void setIterable(Data newIterable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ParallelJPackage.PIPELINE__ITERABLE, oldIterable, iterable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ParallelJPackage.PIPELINE__ITERABLE:
