...
public class ParallelJPackageImpl extends EPackageImpl implements ParallelJPackage {
	 ...
	 * @generated
	 */
	public EReference getPipeline_Iterable() {
	...
	public void createPackageContents() {
		...
		createEReference(pipelineEClass, PIPELINE__ITERABLE);
	...
	public void initializePackageContents() {
		...
		initEReference(getPipeline_Iterable(), this.getData(), null, "iterable", null, 1, 1, Pipeline.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
