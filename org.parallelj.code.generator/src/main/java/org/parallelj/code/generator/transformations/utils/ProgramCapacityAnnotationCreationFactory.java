...
/**
 * This factory allows to create a {@link ProgramCapacityAnnotationCreation}
 ...
 * 
 */
public class ProgramCapacityAnnotationCreationFactory implements
	...
	public AbstractTransformation<Program> create(EObject eObject, String id) {
		return new ProgramCapacityAnnotationCreation((Program) eObject, id);
	}
