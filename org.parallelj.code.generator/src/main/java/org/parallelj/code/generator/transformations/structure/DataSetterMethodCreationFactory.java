...
/**
 * This factory allows to create {@link DataSetterMethodCreation}
 ...
 * 
 */
public class DataSetterMethodCreationFactory implements ITransformationFactory {
	...
	public AbstractTransformation<Data> create(EObject eObject, String id) {
		return new DataSetterMethodCreation((Data) eObject, id);
	}
