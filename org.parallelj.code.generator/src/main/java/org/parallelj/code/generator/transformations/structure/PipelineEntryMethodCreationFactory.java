...
/**
 * This factory allows to create {@link PipelineEntryMethodCreation}
 ...
 * 
 */
public class PipelineEntryMethodCreationFactory implements
	...
	public AbstractTransformation<Pipeline> create(EObject eObject, String id) {
		return new PipelineEntryMethodCreation((Pipeline) eObject, id);
	}
