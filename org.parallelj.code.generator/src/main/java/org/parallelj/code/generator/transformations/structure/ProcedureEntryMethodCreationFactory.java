 ...
 * transformations for each executable procedure of the diagram
 * 
 * @author Antoine Neveux & a169104
 * @version 1.0
 * 
 */
public class ProcedureEntryMethodCreationFactory implements
	...
	public AbstractTransformation<Procedure> create(EObject eObject, String id) {
		return new ProcedureEntryMethodCreation((Procedure) eObject, id,false);
	}
