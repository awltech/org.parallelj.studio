...
/**
 * This factory allows to create a {@link ProgramTestLaunchCreation}
 ...
 * 
 */
public class ProgramTestLaunchCreationFactory implements ITransformationFactory {
	...
	public AbstractTransformation<Program> create(EObject eObject, String id) {
		return new ProgramTestLaunchCreation((Program) eObject, id);
	}
