...
/**
 * This is the item provider adapter for a {@link org.parallelj.model.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_predicate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_predicate_feature", "_UI_Link_type"),
				 ParallelJPackage.Literals.LINK__PREDICATE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ParallelJPackage.Literals.LINK__DESTINATION,
				 true,
				 false,
				 true,
				 null,
