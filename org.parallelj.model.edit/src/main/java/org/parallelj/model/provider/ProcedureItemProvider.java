...
/**
 * This is the item provider adapter for a {@link org.parallelj.model.Procedure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Procedure_executable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Procedure_executable_feature", "_UI_Procedure_type"),
				 ParallelJPackage.Literals.PROCEDURE__EXECUTABLE,
				 true,
				 false,
				 false,
	...
	protected void addJoinPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Procedure_join_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Procedure_join_feature", "_UI_Procedure_type"),
				 ParallelJPackage.Literals.PROCEDURE__JOIN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSplitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Procedure_split_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Procedure_split_feature", "_UI_Procedure_type"),
				 ParallelJPackage.Literals.PROCEDURE__SPLIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addCapacityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Procedure_capacity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Procedure_capacity_feature", "_UI_Procedure_type"),
				 ParallelJPackage.Literals.PROCEDURE__CAPACITY,
				 true,
				 false,
				 false,
