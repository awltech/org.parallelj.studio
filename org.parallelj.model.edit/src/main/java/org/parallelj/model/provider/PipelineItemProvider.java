...
/**
 * This is the item provider adapter for a {@link org.parallelj.model.Pipeline} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PipelineItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pipeline_iterable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pipeline_iterable_feature", "_UI_Pipeline_type"),
				 ParallelJPackage.Literals.PIPELINE__ITERABLE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ParallelJPackage.Literals.PIPELINE__PROCEDURES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ParallelJPackage.Literals.PIPELINE__PROCEDURES,
