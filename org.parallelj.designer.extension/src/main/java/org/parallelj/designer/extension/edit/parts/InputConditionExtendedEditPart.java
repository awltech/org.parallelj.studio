...
public class InputConditionExtendedEditPart extends InputConditionEditPart {

	/**
	 * Default main color of this object
	 */
	private final RGB preferredColor = new RGB(150, 228, 150);
	...
	public InputConditionExtendedEditPart(View view) {
		super(view);
		updateColor(preferredColor, false);
	}

	/**
	 * Fixing the width and height of the InputCondition node and updating
	...
	/**
	 * Creates circle for InputCondition node, with color gradient starting from
	 * top-left to right-bottom, also having light and shadow effect.
	 */
	@Override
	protected IFigure createNodeShape() {
		IFigure figure = new InputConditionFigure() {
