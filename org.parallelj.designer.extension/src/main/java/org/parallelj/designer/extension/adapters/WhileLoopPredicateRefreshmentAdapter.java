...
/**
 * Refreshment adapter for Predicate name in WhileLoop editpart, when predicate
 * is bound/unbound.
 */
public class WhileLoopPredicateRefreshmentAdapter extends
		AbstractRefreshmentAdapter {

	public WhileLoopPredicateRefreshmentAdapter(
	...
	protected int[] getVisualIDsOfEditPartsToRefresh() {
		return new int[] { WhileLoopPredicateEditPart.VISUAL_ID };
	}
