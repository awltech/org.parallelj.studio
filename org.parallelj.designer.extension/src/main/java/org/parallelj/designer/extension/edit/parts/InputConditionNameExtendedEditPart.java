...
public class InputConditionNameExtendedEditPart extends
		InputConditionNameEditPart {

	public InputConditionNameExtendedEditPart(View view) {
		super(view);
	}

	/**
	 * @return icon image for InputConditionName label
	 */
	@Override
	protected Image getLabelIcon() {
		return ImageLoader.getImage(
				ParallelJEditPlugin.INSTANCE.getSymbolicName(),
				"/icons/full/obj16/InputCondition.png");
	}
}
