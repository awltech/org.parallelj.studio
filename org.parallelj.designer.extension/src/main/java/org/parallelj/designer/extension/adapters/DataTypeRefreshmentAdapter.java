...
public class DataTypeRefreshmentAdapter extends AbstractRefreshmentAdapter {

	// Visual id that suppose to refresh on notify
	private static final int[] VISUAL_ID_TO_REFRESH = new int[] { DataNameEditPart.VISUAL_ID, };

	public DataTypeRefreshmentAdapter(AbstractGraphicalEditPart editPart) {
		super(editPart);
	}
	...
	protected int[] getVisualIDsOfEditPartsToRefresh() {
		return DataTypeRefreshmentAdapter.VISUAL_ID_TO_REFRESH;
	}
	...
	protected EStructuralFeature getFeature() {
		return ParallelJPackage.eINSTANCE.getData_Type();
	}
