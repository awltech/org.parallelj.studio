...
public class PipelineProcedureNameExtendedEditPart extends
		PipelineProcedureNameEditPart {

	public PipelineProcedureNameExtendedEditPart(View view) {
		super(view);
	}
	
	/**
	 * @return icon image for PipelineProcedureName label
	 */
	@Override
	protected Image getLabelIcon() {
		return ImageLoader.getImage(
				ParallelJEditPlugin.INSTANCE.getSymbolicName(),
				"/icons/full/obj16/Procedure.png");
	}
