...
public class BlockProcedureNameExtendedEditPart extends
		BlockProcedureNameEditPart {

	public BlockProcedureNameExtendedEditPart(View view) {
		super(view);
	}
	
	/**
	 * @return icon image for BlockProcedureName label
	 */
	@Override
