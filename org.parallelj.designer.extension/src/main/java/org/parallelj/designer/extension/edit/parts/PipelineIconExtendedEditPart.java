...
public class PipelineIconExtendedEditPart extends PipelineIconEditPart {

	public PipelineIconExtendedEditPart(View view) {
		super(view);
	}
	
	/**
	 * @return icon image for PipelineName label
	 */
	@Override
	protected Image getLabelIcon() {
		return ImageLoader.getImage(
				ParallelJEditPlugin.INSTANCE.getSymbolicName(),
				"/icons/full/obj16/Pipeline.png");
	}
