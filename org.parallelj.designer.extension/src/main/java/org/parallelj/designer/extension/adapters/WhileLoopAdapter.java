...
import org.parallelj.designer.extension.edit.parts.WhileLoopExtendedEditPart;
import org.parallelj.model.JoinType;
import org.parallelj.model.ParallelJPackage;
import org.parallelj.model.SplitType;

public class WhileLoopAdapter extends AdapterImpl {
	...
	/**
	 * Created new adapter for WhileLoopExtendedEditPart passed as parameter.
	 * 
	 * @param editPart
	 *            WhileLoopExtendedEditPart
	 */
	public WhileLoopAdapter(AbstractGraphicalEditPart editPart) {
	...
	public final void notifyChanged(Notification notification) {
		...
		if (notification.getEventType() == Notification.ADD
			...
			((WhileLoopExtendedEditPart) this.editPart).updateSplitJoin();
		}
		// if any value set from property view.
			...
			if (currentFeature instanceof EAttribute
				...
				((WhileLoopExtendedEditPart) this.editPart).setJoinIcon(newJoin
						.getName());
			}
			// if SPLIT value set/changed, update SPLIT icon
				...
				((WhileLoopExtendedEditPart) this.editPart)
