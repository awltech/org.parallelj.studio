...
import org.parallelj.designer.extension.adapters.WhileLoopAdapter;
...
public class WhileLoopExtendedEditPart extends WhileLoopEditPart {
	...
	public WhileLoopExtendedEditPart(View view) {
		super(view);
		addAdapters(view);
	...
	private void addAdapters(View view) {
		...
		if (element != null) {
			element.eAdapters().add(new WhileLoopAdapter(this));
	...
	/**
	 * Fixing the height of the WhileLoop node and updating diagram with last
	...
	/**
	 * Creates rectangle for WhileLoop node, with color gradient starting from
	 * top-left to right-bottom, also having light and shadow effect.It will
	 * also show WhileLoop highlighted, if it's linked to any Handler and that
	 * Handler object is selected.
	 */
	@Override
	protected IFigure createNodeShape() {
		IFigure figure = new WhileLoopFigure() {
	...
	public void updateSplitJoin() {
		JoinSplitUpdater.updateSplitJoin(getWhileLoop(), this.getPrimaryShape()
				.getFigureWhileLoopJoinFigure(), this.getPrimaryShape()
				.getFigureWhileLoopSplitFigure());
	}
	...
	public void setJoinIcon(String mode) {
		JoinSplitUpdater.setJoinIcon(getWhileLoop(), mode, this
				.getPrimaryShape().getFigureWhileLoopJoinFigure());
	}
	...
	public void setSplitIcon(String mode) {
		JoinSplitUpdater.setSplitIcon(getWhileLoop(), mode, this
				.getPrimaryShape().getFigureWhileLoopSplitFigure());
	}

	private WhileLoop getWhileLoop() {
		return (WhileLoop) ((View) this.getModel()).getElement();
	}
	...
	/**
	 * It will also show WhileLoop highlighted, if it's linked to any Handler
