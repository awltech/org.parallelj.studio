...
/**
 * Action based on AbstractDiagramPopupAction, for modifying Type
 * values of Data
 */
public class DataTypeModificationAction extends AbstractDiagramPopupAction {
	...
	public void run(IAction action) {
		...
		SetCommand setCommand = new SetCommand(ted, source,
				...
				ExecutableTools.getExecutableFromResourceSelector(source));
