...
public class HandlerNameExtendedEditPart extends HandlerNameEditPart {

	public HandlerNameExtendedEditPart(View view) {
		super(view);
	}

	/**
	 * Sets font of label color to white, even after refresh it maintained the
	 * same.
	 */
	protected void refreshFontColor() {
		super.refreshFontColor();
		// setting font color
		this.setFontColor(ColorConstants.white);
	}

	/**
	 * @return icon image for HandlerName label
	 */
	@Override
	protected Image getLabelIcon() {
		return ImageLoader.getImage(
				ParallelJEditPlugin.INSTANCE.getSymbolicName(),
				"/icons/full/obj16/Handler.png");
	}
}
