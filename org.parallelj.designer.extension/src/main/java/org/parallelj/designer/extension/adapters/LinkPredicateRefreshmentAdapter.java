...
/**
 * Refreshment adapter for Predicate Info label, when predicate is
 * bound/unbound.
 */
public class LinkPredicateRefreshmentAdapter extends AbstractRefreshmentAdapter {

	public LinkPredicateRefreshmentAdapter(AbstractGraphicalEditPart editPart) {
		super(editPart);
	}
