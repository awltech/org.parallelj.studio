...
public class BlockIconExtendedEditPart extends BlockIconEditPart {

	public BlockIconExtendedEditPart(View view) {
		super(view);
	}
	
	/**
	 * @return icon image for BlockName label
	 */
	@Override
	protected Image getLabelIcon() {
		return ImageLoader.getImage(
				ParallelJEditPlugin.INSTANCE.getSymbolicName(),
				"/icons/full/obj16/Block.png");
	}
