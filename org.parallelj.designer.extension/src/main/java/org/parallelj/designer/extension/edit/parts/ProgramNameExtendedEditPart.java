...
public class ProgramNameExtendedEditPart extends ProgramNameEditPart {

	public ProgramNameExtendedEditPart(View view) {
		super(view);
	}

	/**
	 * @return icon image for ProgramName label
	 */
	@Override
	protected Image getLabelIcon() {
		return ImageLoader.getImage(
				ParallelJEditPlugin.INSTANCE.getSymbolicName(),
				"/icons/full/obj16/Program.png");
	}
}
