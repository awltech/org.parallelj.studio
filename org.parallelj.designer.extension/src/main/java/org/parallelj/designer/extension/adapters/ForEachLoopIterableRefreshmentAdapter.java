...
/**
 * Refreshment adapter for ForEachLoop Iterable label, when Data is
 * bound/unbound.
 */
public class ForEachLoopIterableRefreshmentAdapter extends
		AbstractRefreshmentAdapter {

	public ForEachLoopIterableRefreshmentAdapter(
	...
	protected int[] getVisualIDsOfEditPartsToRefresh() {
		return new int[] { ForEachLoopIterableEditPart.VISUAL_ID };
	}
