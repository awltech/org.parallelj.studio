...
/**
 * Refreshment adapter for Predicate Info label, when predicate split value
 * changed.
 */
public class LinkPredicateRefreshmentOnSplitAdapter extends
		AbstractRefreshmentAdapter {

	public LinkPredicateRefreshmentOnSplitAdapter(
