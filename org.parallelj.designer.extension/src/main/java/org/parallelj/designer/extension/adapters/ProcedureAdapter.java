...
import org.parallelj.designer.extension.edit.parts.ProcedureExtendedEditPart;
import org.parallelj.model.JoinType;
import org.parallelj.model.ParallelJPackage;
import org.parallelj.model.SplitType;

public class ProcedureAdapter extends AdapterImpl {
	 ...
	 */
	public ProcedureAdapter(AbstractGraphicalEditPart editPart) {
	...
	public final void notifyChanged(Notification notification) {
		...
		if (notification.getEventType() == Notification.ADD
			...
			((ProcedureExtendedEditPart) this.editPart).updateSplitJoin();
		}
		// if any value set from property view.
			...
			if (currentFeature instanceof EAttribute
				...
				((ProcedureExtendedEditPart) this.editPart).setJoinIcon(newJoin
						.getName());
			}
			// if SPLIT value set/changed, update SPLIT icon
				...
				((ProcedureExtendedEditPart) this.editPart)
