...
public class PredicateNameRefreshmentAdapter extends AbstractRefreshmentAdapter {

	// Visual id that suppose to refresh on notify
	private static final int[] VISUAL_ID_TO_REFRESH = new int[] {
			LinkPredicateInfoEditPart.VISUAL_ID,
			WhileLoopPredicateEditPart.VISUAL_ID };

	public PredicateNameRefreshmentAdapter(AbstractGraphicalEditPart editPart) {
		super(editPart);
	}
	...
	protected int[] getVisualIDsOfEditPartsToRefresh() {
		return PredicateNameRefreshmentAdapter.VISUAL_ID_TO_REFRESH;
	}
