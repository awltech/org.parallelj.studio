...
public class OutputConditionNameExtendedEditPart extends
		OutputConditionNameEditPart {

	public OutputConditionNameExtendedEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		return ImageLoader.getImage(
				...
				"/icons/full/obj16/OutputCondition.png");
	}
}
